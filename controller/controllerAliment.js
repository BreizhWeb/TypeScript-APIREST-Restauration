...
var ControlerAliment = /** @class */ (function () {
    ...
    ControlerAliment.prototype.getAliments = function (req, res) {
    ...
    ControlerAliment.prototype.getAliment = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    ControlerAliment.prototype.postAliment = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var listeAliments;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, aliments_1.Aliment.postOneAliment(req.body)];
                    case 1:
                        listeAliments = _a.sent();
                        res.send(listeAliments);
                        return [2 /*return*/];
    ...
    ControlerAliment.prototype.updateAliment = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        alimentId = req.params.id;
                        return [4 /*yield*/, aliments_1.Aliment.updateOneAliment(alimentId, req.body)];
                    case 1:
                        listeAliments = _a.sent();
                        res.send(listeAliments);
                        return [2 /*return*/];
    ...
    ControlerAliment.prototype.deleteAliment = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var alimentId, listeAliments;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        alimentId = req.params.id;
                        return [4 /*yield*/, aliments_1.Aliment.deleteOneAliment(alimentId)];
                    case 1:
                        listeAliments = _a.sent();
                        res.send(listeAliments);
                        return [2 /*return*/];
